...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_a_product_without_an_id(self):
        """It should raise DataValidationError on Invalid id Update"""
        product = ProductFactory()
        product.id = None
 ...
 #PRODUCT_DATA[]        #data['category'] = "MATHS"
    ...
    def test_find_by_price(self):
        ...
        found_str = Product.find_by_price(f"{price}")
        self.assertEqual(found_str.count(), count)
        for product in found_str:
            self.assertEqual(product.price, price)

    def test_find_by_availability(self):
        """It should Find Pr_strts by Availability"""
